...
function(caffe_pickup_caffe_sources root)
  ...
  caffe_source_group("Include"        GLOB "${root}/include/pcd/*.h*")
  ...
  caffe_source_group("Source"         GLOB "${root}/src/pcd/*.cpp")
  ...
  file(GLOB_RECURSE pcd_hdrs ${root}/include/pcd/*.h*)
  file(GLOB_RECURSE pcd_srcs ${root}/src/pcd/*.cpp)
  ...
  list(APPEND pcd_srcs ${pcd_hdrs} ${PROJECT_BINARY_DIR}/caffe_config.h)
  ...
  set(srcs ${srcs} ${pcd_srcs} PARENT_SCOPE)
